...
void showMenu()
{
	printf("OpenGL Primitives\n");
	printf("-----------------\n\n");
	printf("Click on the \"green\" labels to change parameter values\n\n");
	printf("Press '1' to show big vertices\n");
	printf("Press '2' to add a color command for each vertex\n");
	printf("Press '3' to outline triangle fan, triangle strip and quad strip\n");
	printf("Press '4' to reset parameters\n");
	printf("Press 'f' to set GL_TRIANGLE_FAN primitive\n");
	printf("Press 'g' to set GL_POLYGON primitive\n");
	printf("Press 'l' to set GL_LINES primitive\n");
	printf("Press 'n' to set GL_LINE_LOOP primitive\n");
	printf("Press 'p' to set GL_POINTS primitive\n");
	printf("Press 'q' to set GL_QUADS primitive\n");
	printf("Press 't' to set GL_TRIANGLES primitive\n");
	printf("Press 'u' to set GL_QUAD_STRIP primitive\n");
	printf("Press 'x' to set GL_TRIANGLE_STRIP primitive\n");
	printf("Press 'y' to set GL_LINE_STRIP primitive\n");
...
int main(int argc, char** argv)
{
	...
	window = glutCreateWindow("OpenGL Primitives");
	...
	glutAddMenuEntry("OpenGL Primitives", 0);
	glutAddMenuEntry("", 0);
