...
world_menu(int value)
{
    ...
    switch (value) {
    case 'f':
        name = "../data/obj/fishermen.ppm";
        break;
    case 'o':
        name = "../data/obj/opengl.ppm";
        break;
    case 'c':
        name = "../data/obj/checker.ppm";
        break;
    case 'm':
        name = "../data/obj/marble.ppm";
        break;
    case 't':
        name = "../data/obj/train.ppm";
        break;
    }
    ...
    if (name) {
        ...
        if (!image)
            image = glmReadPPM("../data/obj/fishermen.ppm", &iwidth, &iheight);
    }
...
void main_keyboard(unsigned char key, int x, int y)
{
	switch (key)
	{
		...
		{
			selectedTexture++;
			if(selectedTexture > 4) selectedTexture = 0;
			char* name = 0;
...
void showMenu()
{
	printf("Texture Example\n");
	printf("---------------\n\n");
	printf("Click on the \"green\" labels to change parameter values\n");
	printf("Press 1 to change the texture\n");
	printf("Press 2 to acess texture window transform parameters\n");
	printf("Press 3 to access environment/parameters options\n");
