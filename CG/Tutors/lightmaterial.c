/*
 ...
 Updates:
	* 15/10/2014 - Rodrigo L. S. Silva
	  Add keyboard menu to allow freeglut compatibility (rlss)
*/
...
{
    if (!pmodel) {
        pmodel = glmReadOBJ("../data/obj/soccerball.obj");
        if (!pmodel) exit(0);
        glmUnitize(pmodel);
...
screen_menu(int value)
{
    ...
    switch (value) {
    case 'a':
        name = "../data/obj/al.obj";
        break;
    case 's':
        name = "../data/obj/soccerball.obj";
        break;
    case 'd':
        name = "../data/obj/dolphins.obj";
        break;
    case 'f':
        name = "../data/obj/flowers.obj";
        break;
    case 'j':
        name = "../data/obj/f-16.obj";
        break;
    case 'p':
        name = "../data/obj/porsche.obj";
        break;
    case 'r':
        name = "../data/obj/rose+vase.obj";
        break;
    case 'n':
...
void main_keyboard(unsigned char key, int x, int y)
{
	switch (key)
	{
		...
		{
			selectedMaterial++;
			if(selectedMaterial > 19) selectedMaterial = 1;

			switch (selectedMaterial)
			{
				case 1:
					new_material(Brass);
					changeWindowTitle("Light & Material - Brass Material Selected");
				break;
				case 2:
					new_material(Bronze);
					changeWindowTitle("Light & Material - Bronze Material Selected");
				break;
				case 3:
					new_material(Polished_Bronze);
					changeWindowTitle("Light & Material - Polished_Bronze Material Selected");
				break;
				case 4:
					new_material(Chrome);
					changeWindowTitle("Light & Material - Chrome Material Selected");
				break;
				case 5:
					new_material(Copper);
					changeWindowTitle("Light & Material - Copper Material Selected");
				break;
				case 6:
					new_material(Polished_Copper);
					changeWindowTitle("Light & Material - Polished_Copper Material Selected");
				break;
				case 7:
					new_material(Gold);
					changeWindowTitle("Light & Material - Gold Material Selected");
				break;
				case 8:
					new_material(Polished_Gold);
					changeWindowTitle("Light & Material - Polished_Gold Material Selected");
				break;
				case 9:
					new_material(Pewter);
					changeWindowTitle("Light & Material - Pewter Material Selected");
				break;
				case 10:
					new_material(Silver);
					changeWindowTitle("Light & Material - Silver Material Selected");
				break;
				case 11:
					new_material(Polished_Silver);
					changeWindowTitle("Light & Material - Polished_Silver Material Selected");
				break;
				case 12:
					new_material(Emerald);
					changeWindowTitle("Light & Material - Emerald Material Selected");
				break;
				case 13:
					new_material(Jade);
					changeWindowTitle("Light & Material - Jade Material Selected");
				break;
				case 14:
					new_material(Obsidian);
					changeWindowTitle("Light & Material - Obsidian Material Selected");
				break;
				case 15:
					new_material(Pearl);
					changeWindowTitle("Light & Material - Pearl Material Selected");
				break;
				case 16:
					new_material(Ruby);
					changeWindowTitle("Light & Material - Ruby Material Selected");
				break;
				case 17:
					new_material(Turquoise);
					changeWindowTitle("Light & Material - Turquoise Material Selected");
				break;
				case 18:
					new_material(Black_Plastic);
					changeWindowTitle("Light & Material - Black_Plastic Selected");
				break;
				case 19:
					new_material(Black_Rubber);
					changeWindowTitle("Light & Material - Black_Rubber Selected");
				break;
			}
    }
    break;
    ...
    case 'm':
        ...
        glutDisplayFunc(material_display);
		  changeWindowTitle("Light & Material - Displaying material parameters");
        break;
    case '4':
    case 'l':
        glutSetWindow(command);
        ...
        glutDisplayFunc(lmodel_display);
		  changeWindowTitle("Light & Material - Displaying light model parameters");
        break;
    case '5':
    case 's':
        glutSetWindow(command);
        ...
        glutDisplayFunc(spotlight_display);
		  changeWindowTitle("Light & Material - Displaying spotlight and attenuation parameters");
        break;
    case '6':
    case 'r':
        ...
        two_side.value = 0;
		  changeWindowTitle("Light & Material - Reseting parameters");
        break;
    case 27:
        exit(0);
    }
...
void showMenu()
{
	printf("Light Material Example\n");
	printf("----------------------\n\n");
	printf("Click on the \"green\" labels to change parameter values\n\n");
	printf("Press 1 to change the model\n");
	printf("Press 2 to change the material\n");
	printf("Press 3 to display material parameters\n");
	printf("Press 4 to display light model parameters\n");
	printf("Press 5 to display spotlight and attenuation parameters\n");
	printf("Press 6 to Reset parameters\n");
